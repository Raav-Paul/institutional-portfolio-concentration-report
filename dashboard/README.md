...
- The average Top 5 concentration is approximately **42%**, suggesting most managers distribute capital across a relatively small set of positions.
...
- Vanguard's share in the overall portfolio is at **9.97%**.
- The portfolio exhibits a high level of diversification with approximately **66 effective holdings**.
- Top 5 concentration remains relatively low compared to many active managers.
...
- Vanguard has **zero** **CORE(>10%)** positions compared to the market average of **23%**
- Approximately **66%** of Vanguard's positions are in **TAIL(<1%)** positions, indicating a diversifed tail.
- Their largest position is Nvidia at roughly **$422.74B**
